...
class PageHandler extends \XoopsPersistableObjectHandler
{
    ...
    {
        parent::__construct($db, 'simplepage_page', Page::class, 'pageId', 'title');
    }
     ...
     * @param  string[]  $field  variable to fetch
     ...
     * Returns an array of references ($row pass-by-reference).
     *
     * @param  array  $rows
     * @param  bool  $asObject
